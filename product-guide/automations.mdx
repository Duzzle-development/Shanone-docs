---
title: "Automations"
description: "Manage and automate your tasks with Shanone's automation features"
icon: "workflow"
---

## Overview

Shanone's automation feature allows you to automate tasks and set up recurring workflows with ease.

<Frame>
  <img src="/images/automations-home.png" alt="Automations" />
</Frame>

With Shanone's Automations feature, you can:
...
- **Smart scheduling** - Let Shanone optimize your automations for maximum efficiency

## Getting Started

<Steps>
  <Step title="Access Automations">
    Navigate to the Automations section from your Shanone dashboard.
  </Step>
