---
title: "RemoteGraph"
description: "Call LangGraph RemoteGraph deployed on LangSmith from Shanone"
icon: "laptop"
---

## Overview

RemoteGraph allows you to call LangGraph graphs deployed on LangSmith directly from Shanone. This enables you to leverage your custom AI workflows and agents within Shanone's automation capabilities.

## What is RemoteGraph?

RemoteGraph is a LangGraph feature that allows you to interact with graphs deployed on LangSmith as if they were running locally. By integrating RemoteGraph with Shanone, you can:

- **Execute custom AI workflows** - Run your LangGraph agents from Shanone
...
<Steps>
  ...
  <Step title="Configure in Shanone">
    Add your RemoteGraph configuration in Shanone's settings.
  </Step>
  <Step title="Start using">
    Call your RemoteGraph from Shanone tasks or automations.
  </Step>
</Steps>

## Configuration

To connect your LangSmith deployment to Shanone, you'll need:
...
<CardGroup cols={2}>
  <Card title="Custom AI Agents" icon="robot">
    Run your custom LangGraph agents through Shanone
  </Card>
  ...
  <Card title="Team Collaboration" icon="users">
    Share deployed graphs across your team via Shanone
  </Card>
</CardGroup>
