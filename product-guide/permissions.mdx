...
<Note>
"SA2" refers to Shanone's secondary-administrator role tier — an account can delegate specific policy actions (like managing other users' tool permissions) to an SA2 user without granting full Root access.
</Note>
