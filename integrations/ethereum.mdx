---
title: "Ethereum"
description: "Query Ethereum blockchain data and interact with smart contracts via a JSON-RPC endpoint you provide"
icon: /images/ethereum.svg
---

# Ethereum

Query Ethereum blockchain data, check balances, track transactions, and interact with smart contracts — Shanone talks directly to the Ethereum JSON-RPC endpoint you configure.
...
<Steps>
  <Step title="Go to Integrations">
    Navigate to **Integrations > Ethereum** in the Shanone dashboard.
  </Step>
  <Step title="Add an RPC endpoint">
    Enter your Ethereum JSON-RPC endpoint URL. Alchemy is recommended — it unlocks the token/NFT (`ethereum_alchemy_*`) tools that plain JSON-RPC providers don't support.
  </Step>
  <Step title="Save">
    Once saved, `shanone_execute_tool` calls for `ethereum_*` tools use this endpoint automatically — there's no separate OAuth step for this integration.
  </Step>
</Steps>

## Available Features

Shanone provides **76 tools** for Ethereum, organized into these categories:
...
Shanone supports any EVM-compatible network through custom RPC endpoints:
