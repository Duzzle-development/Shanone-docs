...
<Steps>
  <Step title="Go to Settings">
    Navigate to **Settings > Integrations > Ethereum** in the Shanone dashboard.
  </Step>
  <Step title="Add RPC Endpoint">
    Enter your Ethereum RPC endpoint URL (e.g., Alchemy, Infura, or your own node).
  </Step>
  <Step title="Save Configuration">
    Click "Save" to connect Shanone to the Ethereum network.
  </Step>
</Steps>

## Available Features

Shanone provides **57 tools** for comprehensive Ethereum blockchain interaction, organized into 16 categories:
